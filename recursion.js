...
function longest(words, idx = 0, longestSoFar = 0) {
  ...
  // tracks the longest word up until now and replaces prev longest
  longestSoFar = Math.max(words[idx].length, longestSoFar)
  // recursivesly runs the function adding new idx and updating with new longestSoFar
...
function findIndex(arr, idx=0, val) {
